                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                    <c:forEach var="displaycourse" items="${course}">
                        <tr>
                            <td>${displaycourse.cid}</td>
                            <td>${displaycourse.title}</td>
                            <td>${displaycourse.price}</td>
                            <td>${displaycourse.duration}</td>
                            <td><a href="deleteCourse/${displaycourse.cid}">Delete</a></td>
                            <td><a href="editCourse/${displaycourse.cid}">Edit</a></td>
